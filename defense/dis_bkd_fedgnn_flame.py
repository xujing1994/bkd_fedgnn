...
if __name__ == '__main__':
    ...
    if args.num_mali > 0:
        filename = "/tudelft.net/staff-umbrella/GS/Graph_Neural_Networks/federated_learning_jx/data/global_trigger/flame/%d/%s_%s_%d_%d_%d_%.2f_%.2f_%.2f"\
