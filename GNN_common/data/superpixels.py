...
class SuperPixDatasetDGL(torch.utils.data.Dataset):
    def __init__(self, name, num_val=5000):
        ...
        use_coord = True
        self.test_ = SuperPixDGL("/tudelft.net/staff-umbrella/GS/Graph_Neural_Networks/federated_learning_jx/data/superpixels", dataset=self.name, split='test', 
                            use_mean_px=use_mean_px, 
                            use_coord=use_coord)

        self.train_ = SuperPixDGL("/tudelft.net/staff-umbrella/GS/Graph_Neural_Networks/federated_learning_jx/data/superpixels", dataset=self.name, split='train', 
                             use_mean_px=use_mean_px, 
                             use_coord=use_coord)
        _test_graphs, _test_labels = self.test_[:]
...
class SuperPixDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, name):
        ...
        self.name = name
        data_dir = '/tudelft.net/staff-umbrella/GS/Graph_Neural_Networks/federated_learning_jx/data/superpixels/'
