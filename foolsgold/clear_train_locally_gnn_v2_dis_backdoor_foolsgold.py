import sys
sys.path.append("/home/nfs/jxu8/federated_learning_jx/federated_learning")
            ...
            for epoch in range(params['epochs']):
                ...
                for i in range(args.num_workers):
                    ...
                    if not args.filename == "":
                        save_path = os.path.join(args.filename, '%d'%seed, config['model'] + '_' + args.dataset + \
                ...
                if not args.filename == "":
                    save_path = os.path.join(args.filename,'%d'%seed, MODEL_NAME + '_' + args.dataset + '_%d_%d_%.2f_%.2f_%.2f'\
