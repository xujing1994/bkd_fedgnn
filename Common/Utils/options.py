...
def args_parser():
    ...
    parser.add_argument('--datadir', type=str, default="/tudelft.net/staff-umbrella/GS/Graph_Neural_Networks/TUDataset")
    ...
    parser.add_argument('--filename', type = str, default = "/home/nfs/jxu8/federated_learning_jx/federated_learning/results", help='output file')
